...
def getPersistenceForecast(serie, timestart, score, use_logs=False, 
                             forecast_type='empiricalUK', method='weekly', fN=30, maxlag=1, start='init') -> pd.DataFrame:
...
#hasta aquí todos revisados en la migra y andan OK con series obtenidas mediante APIs REST (deben ser regularizadas). LMG 20241122
